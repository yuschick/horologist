...
[![npm version](https://badge.fury.io/js/horologist.svg)](https://badge.fury.io/js/horologist)
...
| Leap Year Indicator   | [Docs](./packages/horologist/src/components/YearIndicator/)     | A mechanism to indicate the current year's relationships to the next leap year.                                                   |
