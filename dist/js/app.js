...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Timezone = __webpack_require__(125);
	...
	var Dial = function () {
	    function Dial(settings, parentWatch) {
	        ...
	        this.hands = {};
	        if (settings.hands.hour) if (typeof settings.hands.hour === 'string') {
	        ...
	        if (settings.hands.minute) if (typeof settings.hands.minute === 'string') {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var moment = module.exports = __webpack_require__(126);
...
/***/ (function(module, exports) {
	...
	var DateIndicator = function () {
	    function DateIndicator(settings, parentWatch) {
	        ...
	        if ((typeof settings === 'undefined' ? 'undefined' : _typeof(settings)) === 'object' && settings.split) {
	            this.split = true;
