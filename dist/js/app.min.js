...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=n(2),a=n(4),o=n(5),h=n(6),u=n(7),l=function(){function t(e){var n=this
i(this,t),this.dialInstances=[],this.globalInterval=null,this.rightNow=new Date,e.dials.forEach(function(t){var e=new r(t,n)
n.dialInstances.push(e)}),e.crown&&(this.crown=new a(e.crown,this)),e.reserve&&(this.powerReserve=new o(e.reserve,this)),e.moonphase&&(this.moonphase=new h(e.moonphase,this)),e.repeater&&(this.repeaterDial=e.repeater.dial||0,this.repeater=new u(this.dialInstances[this.repeaterDial],e.repeater,this)),this.init()}return s(t,[{key:"keyBindings",value:function(){var t=this
...
switch(n<3&&(e--,n+=12),n++,s=365.25*e,r=30.6*n,a=s+r+i-694039.09,a/=29.5305882,o=parseInt(a),a-=o,o=Math.round(8*a),h=10*a,h=+h.toFixed(2),o>=8&&(o=0),o){case 0:this.rotateDisc(180)
break
...
t.exports=s},function(t,e,n){"use strict"
function i(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var s=function(){function t(t,e){for(var n=0;n<e.length;n++){var i=e[n]
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=n(3),a=function(){function t(e,n,s){i(this,t),this.hands=e.hands,this.hourAngle=0,this.hourChimes=0,this.hourElement=null,this.hourDivisor=12===e.format?30:15,this.allMinutes=0,this.minuteAngle=0,this.fiveMinuteChimes=0,this.fiveMinuteElement=null,this.minuteChimes=0,this.minuteElement=null,this.trigger=document.getElementById(n.id),this.chimes=n.chimes,this.counter=1,this.isPlaying=!1,this.parent=s,this.init()}return s(t,[{key:"convertAngleToIncrements",value:function(){this.hourAngle=r.getCurrentRotateValue(this.hands.hour),this.hourAngle>360&&(this.hourAngle-=360),this.hourChimes=Math.floor(this.hourAngle/this.hourDivisor)||12,console.log(this.hourAngle,this.hourChimes)
try{if(!this.hands.minute)throw"The minute repeater, like, by definition, requires a dial which supports a minute hand."}catch(t){return void console.error(t)}this.minuteAngle=r.getCurrentRotateValue(this.hands.minute),this.minuteAngle>360&&(this.minuteAngle%=360,console.log(this.minuteAngle)),this.allMinutes=Math.floor(this.minuteAngle/6),this.fiveMinuteChimes=Math.floor(this.allMinutes/5),this.minuteChimes=Math.floor(this.allMinutes-5*this.fiveMinuteChimes)}},{key:"bindEvents",value:function(){var t=this
