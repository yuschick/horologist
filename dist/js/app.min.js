...
n(1)
!function(){function t(t){var e=void 0
o.forEach(function(n){if((e=n.attributes["data-comp"].value)===t)return void n.classList.remove("is-hidden")})}function e(e){o.forEach(function(t){t.classList.contains("is-hidden")||t.classList.add("is-hidden")}),t(e)}function i(t){h.forEach(function(t){t.classList.remove("active")}),t.parentElement.classList.add("active")}var s=n(2),r={dials:[{name:"header-dial",hands:{hour:"hour-hand",minute:"minute-hand",second:"second-hand"}}]},a=(new s(r),document.querySelectorAll(".complication-link")),o=document.querySelectorAll(".complication-container"),h=document.querySelectorAll(".secondary-nav li")
a.forEach(function(t){t.addEventListener("click",function(){event.preventDefault(),e(this.attributes["data-comp"].value),i(this)})})}()},function(t,e){"use strict"
