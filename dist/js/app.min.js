...
t.forEach(function(t){if((i=t.attributes[n].value)===e)return void t.classList.toggle("is-hidden")})}function t(){p.forEach(function(e){e.classList.contains("is-hidden")||e.classList.add("is-hidden")})}function i(){d.stopInterval(),d=null,l=null}function s(e){switch(d&&i(),e){case"dials":l={dials:[{name:"primary",hands:{hour:"dial-primary-hour-hand",minute:"dial-primary-minute-hand",second:"dial-primary-second-hand"}},{name:"secondary",hands:{hour:"dial-secondary-hour-hand",minute:"dial-secondary-minute-hand",second:"dial-secondary-second-hand"},offset:"+6",sweep:!0}]}
break
case"day-night-indicator":l={dials:[{hands:{hour:"day-night-hour-hand",minute:"day-night-minute-hand",second:"day-night-second-hand"}}],dayNightIndicator:{id:"day-night-dial"}}
break
case"moonphase":l={dials:[{hands:{hour:"moonphase-hour-hand",minute:"moonphase-minute-hand",second:"moonphase-second-hand"}}],moonphase:{id:"moonphase-dial"}}
break
case"minute-repeater":l={dials:[{hands:{hour:"repeater-hour-hand",minute:"repeater-minute-hand",second:"repeater-second-hand"}}],repeater:{id:"play-repeater",chimes:{hour:"./dist/sounds/chime-01.mp4",quarter:"./dist/sounds/chime-02.mp4",minute:"./dist/sounds/chime-03.mp4"}}}
break
case"power-reserve":l={dials:[{hands:{hour:"reserve-hour-hand",minute:"reserve-minute-hand",second:"reserve-second-hand"}}],reserve:{id:"reserve-hand",range:[-90,90]}}
break
case"manual-time":l={dials:[{name:"primary",hands:{hour:"crown-primary-hour-hand",minute:"crown-primary-minute-hand",second:"crown-primary-second-hand"}},{name:"secondary",hands:{hour:"crown-secondary-hour-hand",minute:"crown-secondary-minute-hand"},offset:"+6"}],crown:{id:"the-crown"}}}d=new u(l)}function r(n){m.forEach(function(e){e.classList.contains("is-hidden")||e.classList.add("is-hidden")}),t(),e(n,m,"data-comp"),s(n)}function a(e){v.forEach(function(e){e.classList.remove("active")}),e.parentElement.classList.add("active")}function o(e){k.forEach(function(t){t.attributes["data-doc-group"].value===e?t.classList.add("is-expanded"):(t.classList.remove("is-expanded"),t.classList.add("is-collapsed"))})}function h(e){e>=57?(y.classList.add("is-fixed"),w.classList.add("fixed-nav")):(y.classList.remove("is-fixed"),w.classList.remove("fixed-nav")),o(e<b.offsetTop+b.clientHeight?"getting-started":e>b.offsetTop+b.clientHeight&&e<T.offsetTop+T.clientHeight?"dials":e>T.offsetTop+T.clientHeight&&e<E.offsetTop+E.clientHeight?"day-night-indicator":e>E.offsetTop+E.clientHeight&&e<I.offsetTop+I.clientHeight?"crown":e>I.offsetTop+I.clientHeight&&e<A.offsetTop+A.clientHeight?"repeater":e>A.offsetTop+A.clientHeight&&e<C.offsetTop+C.clientHeight?"moonphase":e>C.offsetTop+C.clientHeight&&e<D.offsetTop+D.clientHeight?"reserve":"watch")}var u=n(2),c={dials:[{name:"header-dial",hands:{hour:"hour-hand",minute:"minute-hand",second:"second-hand"},sweep:!0}]},l=(new u(c),null),d=null
s("dials")
var f=document.querySelectorAll(".complication-link"),m=document.querySelectorAll(".complication-container"),v=document.querySelectorAll(".secondary-nav li")
f.forEach(function(e){e.addEventListener("click",function(){event.preventDefault(),r(this.attributes["data-comp"].value),a(this)})})
var g=document.querySelectorAll(".view-code-btn"),p=document.querySelectorAll(".complication.code-block-container")
g.forEach(function(t){t.addEventListener("click",function(){event.preventDefault(),e(this.attributes["data-type"].value,p,"data-type")})})
var y=document.querySelector(".docs-tree-container"),w=document.querySelector(".docs-container"),k=document.querySelectorAll(".doc-tree-group"),b=document.querySelector(".getting-started-section"),T=document.querySelector(".dials-section"),E=document.querySelector(".day-night-indicator-section"),I=document.querySelector(".crown-section"),A=document.querySelector(".minute-repeater-section"),C=document.querySelector(".moonphase-section"),D=document.querySelector(".reserve-section")
document.querySelector(".watch-section")
k.forEach(function(e){e.addEventListener("click",function(){o(this.attributes["data-doc-group"].value)})})
var M=!1
window.addEventListener("scroll",function(){M||window.requestAnimationFrame(function(){h(window.scrollY),M=!1}),M=!0})}()},function(e,t){"use strict"
...
i(this,e)
try{if(!t.dials)throw"At least one dial is required for the Watch class."}catch(e){return void console.error(e)}this.dialInstances=[],this.activeDial=0,this.globalInterval=null,this.rightNow=new Date,t.dials.forEach(function(e){var t=new r(e,n)
