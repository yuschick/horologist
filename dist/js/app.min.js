...
n(1)
!function(){function t(t,e,n){var i=void 0
e.forEach(function(e){if((i=e.attributes[n].value)===t)return void e.classList.toggle("is-hidden")})}function e(){v.forEach(function(t){t.classList.contains("is-hidden")||t.classList.add("is-hidden")})}function i(){l.stopInterval(),l=null,u=null}function r(t){switch(l&&i(),t){case"dials":u={dials:[{name:"primary",hands:{hour:"dial-primary-hour-hand",minute:"dial-primary-minute-hand",second:"dial-primary-second-hand"}},{name:"secondary",hands:{hour:"dial-secondary-hour-hand",minute:"dial-secondary-minute-hand",second:"dial-secondary-second-hand"},offset:"+6",sweep:!0}]}
break
...
break
case"manual-time":u={dials:[{name:"primary",hands:{hour:"crown-primary-hour-hand",minute:"crown-primary-minute-hand",second:"crown-primary-second-hand"}},{name:"secondary",hands:{hour:"crown-secondary-hour-hand",minute:"crown-secondary-minute-hand"},offset:"+6"}],crown:{id:"the-crown"}}}l=new o(u)}function s(n){d.forEach(function(t){t.classList.contains("is-hidden")||t.classList.add("is-hidden")}),e(),t(n,d,"data-comp"),r(n)}function a(t){m.forEach(function(t){t.classList.remove("active")}),t.parentElement.classList.add("active")}var o=n(2),h={dials:[{name:"header-dial",hands:{hour:"hour-hand",minute:"minute-hand",second:"second-hand"},sweep:!0}]},u=(new o(h),null),l=null
r("dials")
var c=document.querySelectorAll(".complication-link"),d=document.querySelectorAll(".complication-container"),m=document.querySelectorAll(".secondary-nav li")
c.forEach(function(t){t.addEventListener("click",function(){event.preventDefault(),s(this.attributes["data-comp"].value),a(this)})})
var f=document.querySelectorAll(".view-code-btn"),v=document.querySelectorAll(".complication.code-block-container")
f.forEach(function(e){e.addEventListener("click",function(){event.preventDefault(),t(this.attributes["data-type"].value,v,"data-type")})})}()},function(t,e){"use strict"
t.exports={localStorage:{set:function(t,e){localStorage.setItem(t,JSON.stringify(e))},get:function(t){return void 0!==localStorage[t]&&JSON.parse(localStorage[t])},clear:function(t){localStorage.removeItem(t),console.log(t+" cleared from localStorage.")}}}},function(t,e,n){"use strict"
...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),s=n(3),a=n(4),o=n(5),h=n(6),u=n(7),l=n(8),c=function(){function t(e){var n=this
i(this,t)
...
n.dialInstances.push(e)}),e.crown&&(this.crown=new a(e.crown,this)),e.reserve&&(this.powerReserve=new o(e.reserve,this)),e.moonphase&&(this.moonphase=new h(e.moonphase,this)),e.repeater&&(this.repeaterDial=e.repeater.dial||0,this.repeater=new u(this.dialInstances[this.repeaterDial],e.repeater,this)),e.dayNightIndicator&&(this.dayNightIndicatorDial=e.dayNightIndicator.dial||0,this.dayNightIndicator=new l(this.dialInstances[this.dayNightIndicatorDial],e.dayNightIndicator,this)),this.init()}return r(t,[{key:"getCurrentRotateValue",value:function(t){var e=t.style.transform,n=e.replace("rotate(","").replace("deg)","")
