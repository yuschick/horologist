...
e.forEach(function(e){if((i=e.attributes[n].value)===t)return void e.classList.toggle("is-hidden")})}function e(){v.forEach(function(t){t.classList.contains("is-hidden")||t.classList.add("is-hidden")})}function i(){l.stopInterval(),l=null,u=null}function s(t){switch(l&&i(),t){case"dials":u={dials:[{name:"primary",hands:{hour:"dial-primary-hour-hand",minute:"dial-primary-minute-hand",second:"dial-primary-second-hand"}},{name:"secondary",hands:{hour:"dial-secondary-hour-hand",minute:"dial-secondary-minute-hand",second:"dial-secondary-second-hand"},offset:"+6",sweep:!0}]}
break
case"day-night-indicator":u={dials:[{hands:{hour:"day-night-hour-hand",minute:"day-night-minute-hand",second:"day-night-second-hand"}}],dayNightIndicator:{id:"day-night-dial"}}}l=new o(u)}function r(n){d.forEach(function(t){t.classList.contains("is-hidden")||t.classList.add("is-hidden")}),e(),t(n,d,"data-comp"),s(n)}function a(t){m.forEach(function(t){t.classList.remove("active")}),t.parentElement.classList.add("active")}var o=n(2),h={dials:[{name:"header-dial",hands:{hour:"hour-hand",minute:"minute-hand",second:"second-hand"},sweep:!0}]},u=(new o(h),null),l=null
s("dials")
...
c.forEach(function(t){t.addEventListener("click",function(){event.preventDefault(),r(this.attributes["data-comp"].value),a(this)})})
...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=n(3),a=n(4),o=n(5),h=n(6),u=n(7),l=n(8),c=function(){function t(e){var n=this
i(this,t)
...
return Number(n)}},{key:"keyBindings",value:function(){var t=this
