...
!function(){n(1),n(2),n(11),n(12),n(13)}()},function(t,e){"use strict"
...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),s=n(4),o=n(5),a=n(6),h=n(7),u=n(8),c=n(9),l=n(10),d=n(14),f=function(){function t(e){var n=this
i(this,t)
...
n.dialInstances.push(e)}),e.crown&&(this.crown=new o(e.crown,this)),e.reserve&&(this.powerReserve=new a(e.reserve,this)),e.moonphase&&(this.moonphase=new h(e.moonphase,this)),e.repeater&&(this.repeaterDial=e.repeater.dial||0,this.repeater=new u(this.dialInstances[this.repeaterDial],e.repeater,this)),e.dayNightIndicator&&(this.dayNightIndicatorDial=e.dayNightIndicator.dial||0,this.dayNightIndicator=new c(this.dialInstances[this.dayNightIndicatorDial],e.dayNightIndicator,this)),e.dayIndicator&&(this.dayIndicator=new l(e.dayIndicator,this)),e.date&&(this.dateIndicator=new d(e.date,this)),this.init()}return r(t,[{key:"getCurrentRotateValue",value:function(t){var e=t.style.transform,n=e.replace("rotate(","").replace("deg)","")
...
for(var m=0,v=0;v<n;){var g=u+1.530588*m,p=(c+29.10535608*m)*(3.14159265/180),y=(l+385.81691806*m)*(3.14159265/180),w=(d+390.67050646*m)*(3.14159265/180)
g-=.4068*Math.sin(y)+(.1734-393e-6*s)*Math.sin(p),g+=.0161*Math.sin(2*y)+.0104*Math.sin(2*w),g-=.0074*Math.sin(p-y)-.0051*Math.sin(p+y),g+=.0021*Math.sin(2*p)+.001*Math.sin(2*w-y),g+=.5/1440,f=v,v=h+28*m+Math.floor(g),m++}return(n-f)/29.53059}},{key:"getCurrentPhase",value:function(t){if(t<=.25)[1,0],20-20*t*4
...
t.exports=function(){function t(t){o.forEach(function(t){t.classList.contains("is-hidden")||t.classList.add("is-hidden")}),i.hideAllCodeBlocks(u),i.showSpecificItem(t,o,"data-comp"),r.buildAndShowDemoWatch(t)}function e(t){a.forEach(function(t){t.classList.remove("active")}),t.parentElement.classList.add("active")}var i=n(1),r=n(11),s=document.querySelectorAll(".complication-link"),o=document.querySelectorAll(".complication-container"),a=document.querySelectorAll(".secondary-nav li"),h=document.querySelectorAll(".view-code-btn"),u=document.querySelectorAll(".complication.code-block-container")
...
i.showSpecificItem(t,u,"data-type")})}),r.buildAndShowDemoWatch("dials")}()},function(t,e){"use strict"
t.exports=function(){function t(t){r.forEach(function(e){e.attributes["data-doc-group"].value===t?e.classList.add("is-expanded"):(e.classList.remove("is-expanded"),e.classList.add("is-collapsed"))})}function e(e){e>=57?(n.classList.add("is-fixed"),i.classList.add("fixed-nav")):(n.classList.remove("is-fixed"),i.classList.remove("fixed-nav")),t(e<s.offsetTop+s.clientHeight?"getting-started":e>s.offsetTop+s.clientHeight&&e<o.offsetTop+o.clientHeight?"dials":e>o.offsetTop+o.clientHeight&&e<u.offsetTop+u.clientHeight?"date-indicator":e>o.offsetTop+o.clientHeight&&e<a.offsetTop+a.clientHeight?"day-night-indicator":e>a.offsetTop+a.clientHeight&&e<h.offsetTop+h.clientHeight?"day-indicator":e>a.offsetTop+a.clientHeight&&e<c.offsetTop+c.clientHeight?"crown":e>c.offsetTop+c.clientHeight&&e<l.offsetTop+l.clientHeight?"repeater":e>l.offsetTop+l.clientHeight&&e<d.offsetTop+d.clientHeight?"moonphase":e>d.offsetTop+d.clientHeight&&e<f.offsetTop+f.clientHeight?"reserve":"watch")}var n=document.querySelector(".aside-nav-container")
if(n){var i=document.querySelector(".docs-container"),r=document.querySelectorAll(".doc-tree-group"),s=document.querySelector(".getting-started-section"),o=document.querySelector(".dials-section"),a=document.querySelector(".day-night-indicator-section"),h=document.querySelector(".day-indicator-section"),u=document.querySelector(".date-indicator-section"),c=document.querySelector(".crown-section"),l=document.querySelector(".minute-repeater-section"),d=document.querySelector(".moonphase-section"),f=document.querySelector(".reserve-section")
...
var m=!1
window.addEventListener("scroll",function(){m||window.requestAnimationFrame(function(){e(window.scrollY),m=!1}),m=!0})}}()},function(t,e){"use strict"
function n(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var i=function(){function t(t,e){for(var n=0;n<e.length;n++){var i=e[n]
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=function(){function t(e,i){n(this,t)
