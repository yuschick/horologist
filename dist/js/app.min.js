...
n.dialInstances.push(t)}),t.crown&&(this.crown=new a(t.crown,this)),t.reserve&&(this.powerReserve=new o(t.reserve,this)),t.moonphase&&(this.moonphase=new u(t.moonphase,this)),t.repeater&&(this.repeaterDial=t.repeater.dial||0,this.repeater=new h(this.dialInstances[this.repeaterDial],t.repeater,this)),this.init()}return s(e,[{key:"keyBindings",value:function(){var e=this
...
e.exports=s},function(e,t,n){"use strict"
function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var s=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n]
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),r=n(3),a=function(){function e(t,n,s){i(this,e),this.hands=t.hands,this.hourAngle=0,this.hourChimes=0,this.hourElement=null,this.hourDivisor=12===t.format?30:15,this.allMinutes=0,this.minuteAngle=0,this.fiveMinuteChimes=0,this.fiveMinuteElement=null,this.minuteChimes=0,this.minuteElement=null,this.trigger=document.getElementById(n.id),this.chimes=n.chimes,this.counter=1,this.isPlaying=!1,this.parent=s,this.init()}return s(e,[{key:"convertAngleToIncrements",value:function(){this.hourAngle=r.getCurrentRotateValue(this.hands.hour),this.hourAngle>360&&(this.hourAngle-=360),this.hourChimes=Math.floor(this.hourAngle/this.hourDivisor)
try{if(!this.hands.minute)throw"The minute repeater, like, by definition, requires a dial which supports a minute hand."}catch(e){return void console.error(e)}this.minuteAngle=r.getCurrentRotateValue(this.hands.minute),console.log(this.minuteAngle),this.minuteAngle>360&&(this.minuteAngle%=360,console.log(this.minuteAngle)),this.allMinutes=Math.floor(this.minuteAngle/6),this.fiveMinuteChimes=Math.floor(this.allMinutes/5),this.minuteChimes=Math.floor(this.allMinutes-5*this.fiveMinuteChimes)}},{key:"bindEvents",value:function(){var e=this
