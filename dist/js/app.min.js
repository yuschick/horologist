...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=n(4),o=n(5),a=n(6),h=n(7),u=n(8),c=n(9),l=function(){function t(e){var n=this
i(this,t)
...
n.dialInstances.push(e)}),e.crown&&(this.crown=new o(e.crown,this)),e.reserve&&(this.powerReserve=new a(e.reserve,this)),e.moonphase&&(this.moonphase=new h(e.moonphase,this)),e.repeater&&(this.repeaterDial=e.repeater.dial||0,this.repeater=new u(this.dialInstances[this.repeaterDial],e.repeater,this)),e.dayNightIndicator&&(this.dayNightIndicatorDial=e.dayNightIndicator.dial||0,this.dayNightIndicator=new c(this.dialInstances[this.dayNightIndicatorDial],e.dayNightIndicator,this)),this.init()}return s(t,[{key:"getCurrentRotateValue",value:function(t){var e=t.style.transform,n=e.replace("rotate(","").replace("deg)","")
...
t.exports=function(){function t(t){s.forEach(function(e){e.attributes["data-doc-group"].value===t?e.classList.add("is-expanded"):(e.classList.remove("is-expanded"),e.classList.add("is-collapsed"))})}function e(e){e>=57?(n.classList.add("is-fixed"),i.classList.add("fixed-nav")):(n.classList.remove("is-fixed"),i.classList.remove("fixed-nav")),t(e<r.offsetTop+r.clientHeight?"getting-started":e>r.offsetTop+r.clientHeight&&e<o.offsetTop+o.clientHeight?"dials":e>o.offsetTop+o.clientHeight&&e<a.offsetTop+a.clientHeight?"day-night-indicator":e>a.offsetTop+a.clientHeight&&e<h.offsetTop+h.clientHeight?"crown":e>h.offsetTop+h.clientHeight&&e<u.offsetTop+u.clientHeight?"repeater":e>u.offsetTop+u.clientHeight&&e<c.offsetTop+c.clientHeight?"moonphase":e>c.offsetTop+c.clientHeight&&e<l.offsetTop+l.clientHeight?"reserve":"watch")}var n=document.querySelector(".aside-nav-container")
if(n){var i=document.querySelector(".docs-container"),s=document.querySelectorAll(".doc-tree-group"),r=document.querySelector(".getting-started-section"),o=document.querySelector(".dials-section"),a=document.querySelector(".day-night-indicator-section"),h=document.querySelector(".crown-section"),u=document.querySelector(".minute-repeater-section"),c=document.querySelector(".moonphase-section"),l=document.querySelector(".reserve-section")
...
var d=!1
window.addEventListener("scroll",function(){d||window.requestAnimationFrame(function(){e(window.scrollY),d=!1}),d=!0})}}()}])
