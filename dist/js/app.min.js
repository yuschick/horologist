...
n(1)
!function(){var t=n(2),e={dials:[{name:"header-dial",hands:{hour:"hour-hand",minute:"minute-hand",second:"second-hand"}}]}
new t(e)}()},function(t,e){"use strict"
t.exports={localStorage:{set:function(t,e){localStorage.setItem(t,JSON.stringify(e))},get:function(t){return void 0!==localStorage[t]&&JSON.parse(localStorage[t])},clear:function(t){localStorage.removeItem(t),console.log(t+" cleared from localStorage.")}},getCurrentRotateValue:function(t){var e=t.style.transform,n=e.replace("rotate(","").replace("deg)","")
return Number(n)}}},function(t,e,n){"use strict"
...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=n(3),o=n(4),a=n(5),h=n(6),u=n(7),l=n(8),c=function(){function t(e){var n=this
i(this,t)
try{if(!e.dials)throw"At least one dial is required for the Watch class."}catch(t){return void console.error(t)}this.dialInstances=[],this.globalInterval=null,this.rightNow=new Date,e.dials.forEach(function(t){var e=new r(t,n)
n.dialInstances.push(e)}),e.crown&&(this.crown=new o(e.crown,this)),e.reserve&&(this.powerReserve=new a(e.reserve,this)),e.moonphase&&(this.moonphase=new h(e.moonphase,this)),e.repeater&&(this.repeaterDial=e.repeater.dial||0,this.repeater=new u(this.dialInstances[this.repeaterDial],e.repeater,this)),e.dayNightIndicator&&(this.dayNightIndicatorDial=e.dayNightIndicator.dial||0,this.dayNightIndicator=new l(this.dialInstances[this.dayNightIndicatorDial],e.dayNightIndicator,this)),this.init()}return s(t,[{key:"keyBindings",value:function(){var t=this
...
t.exports=s},function(t,e,n){"use strict"
function i(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var s=function(){function t(t,e){for(var n=0;n<e.length;n++){var i=e[n]
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=n(1),o=function(){function t(e,n,s){i(this,t)
try{if(!n)throw"The MinuteRepeater class requires that an ID of the repeater element be provided."}catch(t){return void console.error(t)}this.hands=e.hands,this.hourAngle=0,this.hourChimes=0,this.hourElement=null,this.hourDivisor=12===e.format?30:15,this.allMinutes=0,this.minuteAngle=0,this.fiveMinuteChimes=0,this.fiveMinuteElement=null,this.minuteChimes=0,this.minuteElement=null,this.trigger=document.getElementById(n.id),this.chimes=n.chimes,this.counter=1,this.isPlaying=!1,this.parent=s,this.init()}return s(t,[{key:"convertAngleToIncrements",value:function(){this.hourAngle=r.getCurrentRotateValue(this.hands.hour),this.hourAngle>360&&(this.hourAngle-=360),this.hourChimes=Math.floor(this.hourAngle/this.hourDivisor)||12
try{if(!this.hands.minute)throw"The minute repeater, like, by definition, requires a dial which supports a minute hand."}catch(t){return void console.error(t)}this.minuteAngle=r.getCurrentRotateValue(this.hands.minute),this.minuteAngle>360&&(this.minuteAngle%=360),this.allMinutes=Math.floor(this.minuteAngle/6),this.fiveMinuteChimes=Math.floor(this.allMinutes/5),this.minuteChimes=Math.floor(this.allMinutes-5*this.fiveMinuteChimes)}},{key:"bindEvents",value:function(){var t=this
this.trigger.addEventListener("click",function(){t.togglePlaying()}),this.hourElement.addEventListener("ended",function(){t.playHours()}),this.fiveMinuteElement.addEventListener("ended",function(){t.playFiveMinutes()}),this.minuteElement.addEventListener("ended",function(){t.playMinutes()})}},{key:"stopAll",value:function(){this.hourElement.pause(),this.hourElement.currentTime=0,this.fiveMinuteElement.pause(),this.fiveMinuteElementcurrentTime=0,this.minuteElement.pause(),this.minuteElementcurrentTime=0,this.counter=1,this.isPlaying=!1}},{key:"togglePlaying",value:function(){this.parent.globalInterval&&(this.isPlaying=!this.isPlaying,this.isPlaying?(this.convertAngleToIncrements(),this.playHours()):this.stopAll())}},{key:"playHours",value:function(){this.counter<=this.hourChimes?(this.hourElement.play(),this.counter++):this.counter===this.hourChimes+1&&(this.counter=1,this.playFiveMinutes())}},{key:"playFiveMinutes",value:function(){this.counter<=this.fiveMinuteChimes?(this.fiveMinuteElement.play(),this.counter++):this.counter===this.fiveMinuteChimes+1&&(this.counter=1,this.playMinutes())}},{key:"playMinutes",value:function(){this.counter<=this.minuteChimes?(this.minuteElement.play(),this.counter++):this.counter===this.minuteChimes+1&&(this.counter=1)}},{key:"buildAudioElements",value:function(){this.hourElement=document.createElement("audio"),this.hourElement.src=this.chimes.hour,document.body.appendChild(this.hourElement),this.fiveMinuteElement=document.createElement("audio"),this.fiveMinuteElement.src=this.chimes.fiveMinute,document.body.appendChild(this.fiveMinuteElement),this.minuteElement=document.createElement("audio"),this.minuteElement.src=this.chimes.minute,document.body.appendChild(this.minuteElement)}},{key:"init",value:function(){this.buildAudioElements(),this.bindEvents()}}]),t}()
t.exports=o},function(t,e,n){"use strict"
function i(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var s=function(){function t(t,e){for(var n=0;n<e.length;n++){var i=e[n]
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=n(1),o=function(){function t(e,n,s){i(this,t)
try{if(!n.id)throw"The DayNightIndicator class requires that an ID of the indiciator element be provided."}catch(t){return void console.error(t)}this.element=document.getElementById(n.id),this.dial=e,this.hands=e.hands,this.parent=s,this.invert=n.invert||!1,this.hours=this.parent.rightNow.getHours(),this.isAM=this.hours<12,this.hourAngle=0,this.hourDivisor=12===e.format?30:15,this.init()}return s(t,[{key:"toggleAMPM",value:function(){this.isAM=!this.isAM}},{key:"removeTransitionDuration",value:function(){this.element.style.transition="none"}},{key:"rotateIndicator",value:function(){var t=0
