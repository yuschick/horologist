...
!function(){n(1),n(2),n(10),n(11),n(12)}()},function(t,e){"use strict"
...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=n(4),o=n(5),a=n(6),h=n(7),u=n(8),c=n(9),l=n(13),d=function(){function t(e){var n=this
i(this,t)
...
n.dialInstances.push(e)}),e.crown&&(this.crown=new o(e.crown,this)),e.reserve&&(this.powerReserve=new a(e.reserve,this)),e.moonphase&&(this.moonphase=new h(e.moonphase,this)),e.repeater&&(this.repeaterDial=e.repeater.dial||0,this.repeater=new u(this.dialInstances[this.repeaterDial],e.repeater,this)),e.dayNightIndicator&&(this.dayNightIndicatorDial=e.dayNightIndicator.dial||0,this.dayNightIndicator=new c(this.dialInstances[this.dayNightIndicatorDial],e.dayNightIndicator,this)),e.dayIndicator&&(this.dayIndicator=new l(e.dayIndicator,this)),this.init()}return s(t,[{key:"getCurrentRotateValue",value:function(t){var e=t.style.transform,n=e.replace("rotate(","").replace("deg)","")
...
t.exports=d},function(t,e){"use strict"
...
var s=function(){function t(e,i){n(this,t)
try{if(!e.id)throw"The MoonPhase class requires that an ID of the moonphase element be provided."}catch(t){return void console.error(t)}this.parent=i,this.element=document.getElementById(e.id),this.invert=e.invert||!1,this.init()}return i(t,[{key:"rotateDisc",value:function(t){t=this.invert?-1*t:t,this.element.style.transform="rotate("+t+"deg)"}},{key:"moon_day",value:function(t){var e=function(t){return t-Math.floor(t)},n=t.getJulian(),i=t.getFullYear(),s=void 0,r=void 0,o=void 0,a=void 0,h=void 0,u=void 0,c=void 0,l=void 0,d=void 0,f=void 0
s=Math.floor(12.3685*(i-1900)),r=(i-1899.5)/100,o=r*r,a=r*r*r,h=2415020+29*s,u=1178e-7*o-1.55e-7*a+(.75933+.53058868*s)-(837e-6*r+335e-6*o),c=360*e(.08084821133*s)+359.2242-333e-7*o-347e-8*a,l=360*e(.07171366128*s)+306.0253+.0107306*o+1236e-8*a,d=360*e(.08519585128*s)+21.2964-.0016528*o-239e-8*a
...
g-=.4068*Math.sin(y)+(.1734-393e-6*r)*Math.sin(p),g+=.0161*Math.sin(2*y)+.0104*Math.sin(2*w),g-=.0074*Math.sin(p-y)-.0051*Math.sin(p+y),g+=.0021*Math.sin(2*p)+.001*Math.sin(2*w-y),g+=.5/1440,f=v,v=h+28*m+Math.floor(g),m++}return(n-f)/29.53059}},{key:"getCurrentPhase",value:function(t){if(t<=.25)[1,0],20-20*t*4
...
t.exports=function(){function t(t){o.forEach(function(t){t.classList.contains("is-hidden")||t.classList.add("is-hidden")}),i.hideAllCodeBlocks(u),i.showSpecificItem(t,o,"data-comp"),s.buildAndShowDemoWatch(t)}function e(t){a.forEach(function(t){t.classList.remove("active")}),t.parentElement.classList.add("active")}var i=n(1),s=n(10),r=document.querySelectorAll(".complication-link"),o=document.querySelectorAll(".complication-container"),a=document.querySelectorAll(".secondary-nav li"),h=document.querySelectorAll(".view-code-btn"),u=document.querySelectorAll(".complication.code-block-container")
r.forEach(function(n){n.addEventListener("click",function(){event.preventDefault(),t(this.attributes["data-comp"].value),e(this)})}),h.forEach(function(t){t.addEventListener("click",function(){event.preventDefault()
var t=this.attributes["data-type"].value
i.showSpecificItem(t,u,"data-type")})}),s.buildAndShowDemoWatch("dials")}()},function(t,e){"use strict"
t.exports=function(){function t(t){s.forEach(function(e){e.attributes["data-doc-group"].value===t?e.classList.add("is-expanded"):(e.classList.remove("is-expanded"),e.classList.add("is-collapsed"))})}function e(e){e>=57?(n.classList.add("is-fixed"),i.classList.add("fixed-nav")):(n.classList.remove("is-fixed"),i.classList.remove("fixed-nav")),t(e<r.offsetTop+r.clientHeight?"getting-started":e>r.offsetTop+r.clientHeight&&e<o.offsetTop+o.clientHeight?"dials":e>o.offsetTop+o.clientHeight&&e<a.offsetTop+a.clientHeight?"day-night-indicator":e>a.offsetTop+a.clientHeight&&e<h.offsetTop+h.clientHeight?"day-indicator":e>a.offsetTop+a.clientHeight&&e<u.offsetTop+u.clientHeight?"crown":e>u.offsetTop+u.clientHeight&&e<c.offsetTop+c.clientHeight?"repeater":e>c.offsetTop+c.clientHeight&&e<l.offsetTop+l.clientHeight?"moonphase":e>l.offsetTop+l.clientHeight&&e<d.offsetTop+d.clientHeight?"reserve":"watch")}var n=document.querySelector(".aside-nav-container")
if(n){var i=document.querySelector(".docs-container"),s=document.querySelectorAll(".doc-tree-group"),r=document.querySelector(".getting-started-section"),o=document.querySelector(".dials-section"),a=document.querySelector(".day-night-indicator-section"),h=document.querySelector(".day-indicator-section"),u=document.querySelector(".crown-section"),c=document.querySelector(".minute-repeater-section"),l=document.querySelector(".moonphase-section"),d=document.querySelector(".reserve-section")
document.querySelector(".watch-section")
s.forEach(function(e){e.addEventListener("click",function(){t(this.attributes["data-doc-group"].value)})})
var f=!1
