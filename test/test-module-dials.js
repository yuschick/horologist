...
describe('Dials', () => {
    ...
    it('should return an error from the Watch class for not providing dial hands', () => {
        ...
        const test = () => new Watch(settings);
        assert.throws(test, ReferenceError, 'The Dial class needs an object containing the HTML elements for the hands.');
    });
    ...
    it('should return an error from the Watch class not providing a retrograde id', () => {
        ...
        const test = () => new Watch(settings);
        assert.throws(test, ReferenceError, 'The retrograde second requires an id property be provided.');
    });
    ...
    it('should return an error from the Watch class having multiple second hands', () => {
        ...
        const test = () => new Watch(settings);
        assert.throws(test, ReferenceError, 'A dial can only support one second hand at a time - either traditional or retrograde.');
    });
    ...
    it('should return an error from a retrograde second with too short a duration', () => {
        ...
        const test = () => new Watch(settings);
        assert.throws(test, ReferenceError, 'The retrograde second hand requires a duration no less than 5.');
    });
    ...
    it('should return an error from the Watch class having a retrograde duration not divisible by 60', () => {
        ...
        const test = () => new Watch(settings);
        assert.throws(test, ReferenceError, 'The retrograde second hand requires a duration that is evenly divisble by 60.');
    });
